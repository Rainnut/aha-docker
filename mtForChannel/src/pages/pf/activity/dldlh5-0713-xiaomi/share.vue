...
<div class="share-container">
  ...
  <div ref="btnToBook" class="btn-to-book" @click="goToBookPage"></div>
</div>
</template>
...
export default {
  ...
  methods: {
    goToBookPage () {
      window.location.href = 'migamecenter://openurl/https://game.xiaomi.com/gcAct/reservationDownload/index.html?refresh=true&hideTitleBar=1&actId=2490'
    },
    setLevelImg () {
      let levelArr
...
.tips {
  ...
  height: 2.13rem;
  color: #fff;
  background: url('./image/share-text-tips.png') no-repeat center/contain;
}
.ewm-wrap.ewm-show {
  opacity: 1;
}
