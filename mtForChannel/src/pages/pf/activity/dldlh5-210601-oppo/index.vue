...
export default {
  ...
  mounted () {
    if (!this.mobile || !this.canHack()) {
      ...
      // document.getElementsByTagName('html')[0].style.background = '#d7cbbf'
...
html {
  height: 100%;
  background: url("./image/ditu.jpg") no-repeat center/cover;
}
</style>
...
.book-page-share-wrapper, .generate-img-wrapper {
  display: none;
  position: fixed;
  z-index: 99;
