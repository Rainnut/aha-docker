...
export default {
  ...
  methods: {
    ...
    oppoBookGame () {
      const self = this
      const heytap = window.heytap
      // const isAppReserved = heytap.isAppReserved(this.appid)
      // console.log('判断是否预约：isAppReserved', this.appid)
      // if (!isAppReserved) {
      //   console.log('预约游戏：appoint', this.appid)
      //   heytap.appoint(this.appid, function () {
      //     self.sendTrack('book_uuid', 5, '预约游戏成功')
      //     console.log('预约游戏，成功')
      //   })
      // }
      console.log('预约游戏：appoint', this.appid)
